                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-12">
                            <div class="about-image-wrap custom-border-radius-start">
                                <img src="{{asset('images/professional-asian-businesswoman-gray-blazer.jpg')}}" class="about-image custom-border-radius-start img-fluid" alt="">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12">
                                ...
                                <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4">
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex flex-wrap align-items-center">
                                            ...
                                            <div class="d-flex">
                                                <p class="mb-0">
                                                    <a href="{{route('job.listings')}}" class="badge badge-level">Senior</a href="{{route('job.listings')}}">
                                                </p>
                            ...
                            <div class="job-thumb d-flex">
                                <div class="job-image-wrap bg-white shadow-lg">
                                    <img src="{{asset('images/logos/creative-market.png')}}" class="job-image img-fluid" alt="">
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="video-thumb">
                                <img src="{{asset('images/people-working-as-team-company.jpg')}}" class="about-image custom-border-radius-end img-fluid" alt="">
                    ...
                    <div class="row align-items-center">
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src="{{asset('images/logos/salesforce.png')}}" class="job-image me-3 img-fluid" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="{{route('job.details')}}">
                                        <img src="{{asset('images/jobs/marketing-assistant.jpg')}}" class="job-image img-fluid" alt="marketing assistant">
                                    </a>
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src="{{asset('images/logos/spotify.png')}}" class="job-image me-3 img-fluid" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src="{{asset('images/logos/twitter.png')}}" class="job-image me-3 img-fluid" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="{{route('job.details')}}">
                                        <img src="{{asset('images/jobs/pretty-blogger-posing-cozy-apartment.jpg')}}" class="job-image img-fluid" alt="">
                                    </a>
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src="{{asset('images/logos/yelp.png')}}" class="job-image me-3 img-fluid" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="{{route('job.details')}}">
                                        <img src="{{asset('images/jobs/paper-analysis.jpg')}}" class="job-image img-fluid" alt="">
                                    </a>
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src="{{asset('images/logos/paypal.png')}}" class="job-image me-3 img-fluid" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="{{route('job.details')}}">
                                        <img src="{{asset('images/jobs/logo-designer-working-computer-desktop.jpg')}}" class="job-image img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-lg-4 col-12 recent-jobs-bottom d-flex ms-auto my-4">
                            <a href="{{route('job.listings')}}" class="custom-btn btn ms-lg-auto">Browse Job Listings</a>
                        </div>
                        ...
                        <div class="col-lg-12 col-12">
                            ...
                            <div class="owl-carousel owl-theme reviews-carousel">
                                ...
                                <div class="reviews-thumb">
                                    ...
                                    <div class="reviews-info d-flex align-items-center">
                                        <img src="{{asset('images/avatar/portrait-beautiful-young-woman.jpg')}}" class="avatar-image img-fluid" alt="">
                                ...
                                <div class="reviews-thumb">
                                    <div class="reviews-info d-flex align-items-center">
                                        <img src="{{asset('images/avatar/university-study-abroad-lifestyle-concept.jpg')}}" class="avatar-image img-fluid" alt="">
