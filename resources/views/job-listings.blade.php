                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="{{route('job.details')}}">
                                        <img src="{{asset('images/jobs/portrait-woman-customer-service-worker.jpg')}}" class="job-image img-fluid" alt="">
                                    </a>
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src="{{asset('images/logos/microsoft.png')}}" class="job-image me-3 img-fluid" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="{{route('job.details')}}">
                                        <img src="{{asset('images/jobs/young-woman-teaching-english-lessons.jpg')}}" class="job-image img-fluid" alt="">
                                    </a>
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src="{{asset('images/logos/dropbox.png')}}" class="job-image me-3 img-fluid" alt="">
                         ...
                         <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="{{route('job.details')}}">
                                        <img src="{{asset('images/jobs/sound-engineer-working-studio-with-equipment.jpg')}}" class="job-image img-fluid" alt="">
                                    </a>
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src="{{asset('images/logos/soundcloud.png')}}" class="job-image me-3 img-fluid" alt="">
